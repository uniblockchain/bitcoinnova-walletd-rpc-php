...
namespace Bitcoinnova;

use Bitcoinnova\Http\JsonResponse;
use Bitcoinnova\Http\RpcClient;

/**
 * Class Bitcoinnova.Service
 * Wrapper for Bitcoinnova's Bitcoinnova-service (formerly walletd) JSON-RPC interface.
 * @package Bitcoinnova
 */
class Bitcoinnova.Service extends RpcClient
{
    /** @var int */
     ...
     * because Bitcoinnova-service supports multiple addresses in one container, not all wallets can have a mnemonic seed,
    ...
    /**
     * Retrieves the address, and fee for the node that the Bitcoinnova-service instance is connected to.
