...
/**
 * Wrapper for Bitcoinnova's Bitcoinnovad JSON-RPC interface.
 * @package Bitcoinnova
 */
class Bitcoinnovad extends RpcClient
{
    /** @var int */
    protected $rpcPort = 45223;
     ...
     * @param string $address     Valid Bitcoinnova wallet address. Required.
     * @return JsonResponse
     */
